...
function ToggleTheme() {
  ...
  const setTheme = ()=> {
    ...
    darkMode ? document.documentElement.setAttribute('color-theme', 'light') : document.documentElement.setAttribute('color-theme', 'dark');
  }
  ...
  return (
    ...
    <div className='theme-container'>
        <input type='checkbox' id='mode-toggle' 
          checked={darkMode}
          onChange={setTheme}/>
        <label htmlFor='mode-toggle' className='mode-toggle'>
